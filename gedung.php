...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link page-scroll" href="#gedung">Gedung</a>
                    </li>
                    <li class="nav-item">
    ...
    <section class="gedung" id="gedung">
        <div class="container container-fluid">
            ...
            <div class="main">
                <div class="gallery">
                    ...
                    <div class="img">
                    <a href="detailgedung.php">
                            <img src="./assets/image/g5.jpg" />\
                        </a>
                    </div>
                    <div class="img">
                    <a href="detailgedung.php">
                            <img src="./assets/image/g6.jpg" />\
                        </a>
                    </div>
                    <div class="img">
                    <a href="detailgedung.php">
                            <img src="./assets/image/g7.jpg" />\
                        </a>
                    </div>
                    <div class="img">
                    <a href="detailgedung.php">
                            <img src="./assets/image/g8.jpg" />\
                        </a>
                    </div>
                </div>
            </div>
