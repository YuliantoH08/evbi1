			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select"  required>
						...
						<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected': '' ?>>Editor</option>
						<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected': '' ?>>Registred</option>
					</select>
				</div>
				<div class="form-group col-6">
