...
<div class="container-fluid">
    <form action="" id="eventlist-form">
        ...
        <div class="form-group">
            ...
            <textarea rows="3" name="description" id="description" class="form-control form-control-border" placeholder="Write the Event description here." required><?php echo isset($description) ? $description : '' ?></textarea>
        </div>
        <div class="form-group">
...
<script>
    $(function(){
        $('#uni_modal #eventlist-form').submit(function(e){
            e.preventDefault();
            var _this = $(this)
            $('.pop-msg').remove()
            var el = $('<div>')
